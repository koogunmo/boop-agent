/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2e49b8aa268e3cf06219d0c56d2b4213)
// Runtime types generated with workerd@1.20260421.1 2026-04-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BoopInteractionAgent" | "BoopExecutionAgent";
	}
	interface Env {
		PROACTIVE_KV: KVNamespace;
		LOADER: WorkerLoader;
		BROWSER: Fetcher;
		AI: Ai;
		...
		MODEL_ADVERSARY: "workers-ai/@cf/moonshotai/kimi-k2.6";
		SENDBLUE_FROM_NUMBER: "+16452438873";
		COMPOSIO_USER_ID: "boop-default";
		MODEL_CLASSIFIER: "@cf/meta/llama-3.1-8b-instruct";
		CONVEX_URL: string;
		...
		MODEL_PROPOSER: string;
		MODEL_JUDGE: string;
		COMPOSIO_WEBHOOK_SECRET: string;
		BOOP_AGENT: DurableObjectNamespace<import("./src/index").BoopInteractionAgent>;
		EXEC_AGENT: DurableObjectNamespace<import("./src/index").BoopExecutionAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOOP_MODEL" | "MODEL_DISPATCHER" | "MODEL_EXECUTOR" | "MODEL_EXTRACTION" | "MODEL_ADVERSARY" | "SENDBLUE_FROM_NUMBER" | "COMPOSIO_USER_ID" | "MODEL_CLASSIFIER" | "CONVEX_URL" | "CF_ACCOUNT_ID" | "CF_GATEWAY_ID" | "CF_API_TOKEN" | "SENDBLUE_API_KEY" | "SENDBLUE_API_SECRET" | "SERPER_API_KEY" | "COMPOSIO_API_KEY" | "CONVEX_WEBHOOK_SECRET" | "MODEL_PROPOSER" | "MODEL_JUDGE" | "COMPOSIO_WEBHOOK_SECRET">> {}
}
